...
const arr = ['two', 'one', 'two', 'three', 'two', 'four', 'one', 'four', 'two', 'two'];
// -----------'method #1'--------------
console.time('Function #1');
const unique = [];

for (const [index, item] of arr.sort().entries()) {
  item !== arr[index - 1] ? unique.push(item) : 0;
}
console.log(unique);
